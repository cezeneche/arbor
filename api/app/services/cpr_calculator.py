...
def get_qualifying_schemes(country_code: str) -> list[UKQualifyingScheme]:
    ...
    This uses the in-memory registry; for production use ``cpr_repository.lookup_qualifying_schemes_db``.
    """
...
def calculate_cpr(
    ...
    exchange_rate_to_gbp:
        ...
        date of import.  Use ``cpr_repository.get_exchange_rate_db()`` to retrieve the
        HMRC reference rate.
    cbam_liability_gbp:
