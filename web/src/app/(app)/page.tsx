...
export default function DashboardPage() {
  ...
  // Sector distribution (approximate from status)
  const sectorData = [
        ...
        <Card className="bg-slate-900 border-slate-800 lg:col-span-2">
          ...
          <CardContent>
            {isLoading ? (
              ...
              <p className="text-slate-500 text-sm py-4 text-center">No cases yet. <Link href="/cases/new" className="text-teal-400 hover:underline">Create one</Link>.</p>
            ) : (
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={sectorData} layout="vertical" margin={{ left: 8, right: 16 }}>
                ...
                <YAxis dataKey="sector" type="category" width={70} tick={{ fill: "#94a3b8", fontSize: 11 }} axisLine={false} tickLine={false} />
